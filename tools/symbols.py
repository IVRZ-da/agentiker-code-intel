#!/usr/bin/env python3
"""
tools/symbols.py — Symbol-Extraktion aus code_tools.py ausgelagert.

AST-powered symbol extraction using tree-sitter queries.
...
def code_symbols_tool(
    ...
    try:
        ...
        return fmt_err("Code intelligence dependencies are not installed. "
                        "Please run: uv pip install 'hermes-agent[code-intel]'")
...
try:
    ...
    registry = None  # Graceful degradation: skip registration
